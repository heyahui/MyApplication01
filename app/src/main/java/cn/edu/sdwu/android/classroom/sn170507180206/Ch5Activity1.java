...
public class Ch5Activity1 extends AppCompatActivity {
    ...
    public void alert_dialog(View view){
        ...
        builder.setPositiveButton("confirm", new DialogPreference() {
            public void onClick(DialogPreference dialogPreference,int i){
                Toast.makeText(Ch5Activity1.this, "confiem", Toast.LENGTH_SHORT).show();
            }
        });
        builder.setNeutralButton("cnacle", new DialogInterface.OnClickListener() {

            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(Ch5Activity1.this,"cancle",Toast.LENGTH_SHORT).show();
            }
        });
        builder.create().show();
    }
